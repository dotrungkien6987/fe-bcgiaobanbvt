...
const DieuHanh = () => {
  ...
  //   }, []);
  const dataCLSNoiTru = [];
  dataCLSNoiTru.push(chisosObj.xn_noitru || 0);
  dataCLSNoiTru.push(chisosObj.xq_noitru || 0);
  dataCLSNoiTru.push(chisosObj.ct32_noitru || 0);
  dataCLSNoiTru.push(chisosObj.ct128_noitru || 0);
  dataCLSNoiTru.push(chisosObj.ct128_noitru_bhyt || 0);
  dataCLSNoiTru.push(chisosObj.mri30_noitru || 0);
  dataCLSNoiTru.push(chisosObj.mri15_noitru || 0);
  dataCLSNoiTru.push(chisosObj.sa_noitru || 0);
  dataCLSNoiTru.push(chisosObj.cnhh_noitru || 0);
  dataCLSNoiTru.push(chisosObj.mdlx_noitru || 0);
  dataCLSNoiTru.push(chisosObj.ns_noitru || 0);
  dataCLSNoiTru.push(chisosObj.dn_noitru || 0);
  dataCLSNoiTru.push(chisosObj.dt_noitru || 0);

  const dataCLSNgoaiTru = [];
  dataCLSNgoaiTru.push(chisosObj.xn_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.xq_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.ct32_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.ct128_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.ct128_ngoaitru_bhyt || 0);
  dataCLSNgoaiTru.push(chisosObj.mri30_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.mri15_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.sa_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.cnhh_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.mdlx_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.ns_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.dn_ngoaitru || 0);
  dataCLSNgoaiTru.push(chisosObj.dt_ngoaitru || 0);

...
function TableCanLamSangKhoa({ canlamsangDuyetKeToan, canlamsangChiDinh,ngayhientai}) {
            ...
            {canlamsangDuyetKeToan.name && canlamsangDuyetKeToan.name.map((row, index) => (
              ...
              >
                ...
                >
                  ...
                  {canlamsangDuyetKeToan.bhyt_chenhlech[index] !== 0 && hienthiChenhLech && (
                    <Typography
                      sx={{
                        fontSize: "0.8rem",
                        color:
...
export default TableCanLamSangKhoa;

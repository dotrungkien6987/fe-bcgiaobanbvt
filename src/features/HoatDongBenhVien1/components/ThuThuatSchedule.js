...
import { selectSoThuTuPhongThucHien, getAllSoThuTuStats } from '../../Slice/soThuTuSlice';
...
const ThuThuatSchedule = ({ isCompactView }) => {
  ...
  const phongThucHienData = useSelector(selectSoThuTuPhongThucHien);  const khoasFromRedux = useSelector(selectKhoas);
    ...
    return (
      <Grid item xs={12}>
        <Paper sx={{ p: 2, textAlign: 'center' }}>
          <Typography variant="body1">Không có dữ liệu phòng thủ thuật</Typography>
        </Paper>
      </Grid>
    );
  }
    ...
    return (
      <Grid item xs={12} md={isCompactView ? 6 : 12} lg={isCompactView ? 4 : 12} key={department.id}>
        ...
        >
          ...
          {/* Thông tin số thứ tự */}
          {phongThucHienData && phongThucHienData.length > 0 && (() => {
              ...
              return (
                <>
                  ...
                  <Box sx={{ 
                    ...
                    <Chip 
                      label={`STT: ${soThuTuData.latest_sothutunumber_da_thuc_hien || 'N/A'}`} 
                      color="primary" 
                      size="small" 
                      variant="outlined"
                      sx={{ fontWeight: 'bold' }}
                    ...
                    <Grid container spacing={1} sx={{ mb: 1.5 }}>
                      <Grid item xs={6}>
                        <Box sx={{ 
                          ...
                          <Typography variant="caption" color="text.secondary">Tổng số CLS</Typography>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <BiotechIcon fontSize="small" sx={{ mr: 0.5, color: color }} />
                      ...
                      <Grid item xs={6}>
                        <Box sx={{ 
                          ...
                          <Typography variant="caption" color="text.secondary">Tổng người bệnh</Typography>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      <Grid item xs={4}>
                        <Box sx={{ 
                          ...
                          <Typography variant="caption" color="text.secondary" noWrap>Chờ thực hiện</Typography>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      <Grid item xs={4}>
                        <Box sx={{ 
                          ...
                          <Typography variant="caption" color="text.secondary" noWrap>Đợi kết quả</Typography>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Grid item xs={6}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <Typography variant="body1" fontWeight="bold" color="info.main">
                              {soThuTuData.max_sothutunumber_da_thuc_hien || 'N/A'}
                            </Typography>
                          </Box>
                        </Grid>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mb: 1 }}>
                    <Chip
                      icon={<AccessTimeIcon />}
                      label={`Số tiếp theo: ${soThuTuData.sothutunumber_du_kien_tiep_theo || 'N/A'}`} 
                      size="medium"

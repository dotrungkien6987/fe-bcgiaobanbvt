 ...
 *
 * Moved from features/QuanLyCongViec/Ticket/components/ to shared components
 * for reuse across the application via MobileDetailLayout
 */
...
export default function PullToRefreshWrapper({
  ...
  if (!isMobile) {
    // DESKTOP: Regular wrapper without pull-to-refresh (but with scroll tracking)
    return (
      <Box
        ref={containerRef}
